...
//         selectedItemColor: const Color(0xFF162836),
//         onTap: _onItemTapped,
//       ),
//     );
//   }
...
//           IconButton(
//             icon: const Icon(Icons.swap_vert, color: Color(0xFF162836)),
...
//         borderSide: const BorderSide(color: Color(0xFF162836)),
//       ),
...
//       labelText: 'Amount',
//       border: OutlineInputBorder(),
//       hintText: 'Enter amount', // Added hint text instead of default value
//     ),
//     onChanged:
//         (value) => setState(() {
...
//   Widget _buildConversionResults() => Column(
//     children: [
//       Text(
...
//           : _amount > 0
//           ? Text(
//             '${_amount.toStringAsFixed(2)} ${_fromCurrency?.code} = ${(_amount * _conversionRate).toStringAsFixed(2)} ${_toCurrency?.code}',
